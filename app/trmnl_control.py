...
class TRMNLController:
    ...
    def create_image(
        self, content: str = None, device_id: str = None, filename: str = None, **kwargs
    ) -> str:
        """
        ...
        filename, file_path = self.image_gen.create_image(
            content=content, filename=filename, **kwargs
        )

        return filename

    def create_html_image(
        self, html_content: str, device_id: str = None, filename: str = None
    ) -> str:
        """
    ...
    def create_big_text_image(
        ...
        filename, file_path = self.image_gen.create_big_text_image(
    ...
    def schedule_update(
        self, update_function, interval_minutes: int = 30, device_id: str = None
    ):
        """
...
def create_image(
    content: str = None, device_id: str = None, filename: str = None, **kwargs
) -> str:
    """
...
def create_big_text_image(
    text: str, subtitle: str = None, device_id: str = None, filename: str = None
) -> str:
    """
